-- Revert article embeddings to Nomic nomic-embed-text (768 dims).
...
-- Recreate embedding column at 768 dimensions.
...
-- Update function signature to use the 768 dimension.
